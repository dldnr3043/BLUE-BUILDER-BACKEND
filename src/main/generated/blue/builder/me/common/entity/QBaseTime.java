package blue.builder.me.common.entity;
...
public class QBaseTime extends EntityPathBase<BaseTime> {
    ...
    private static final long serialVersionUID = -1806123787L;
    ...
    public final DateTimePath<java.time.LocalDateTime> updDttm = createDateTime("updDttm", java.time.LocalDateTime.class);
